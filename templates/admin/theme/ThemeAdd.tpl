...
<form action="ThemeAdd.php" method="post" class="form-horizontal"> 
			...
			<div class="span6">
				...
				<div class="portlet box blue tabbable" style="width:800px;">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>新增二级标题</div>
								...
								<div class="control-group">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" placeholder="请输入页面路径" class="m-wrap large" name="Path"/>
