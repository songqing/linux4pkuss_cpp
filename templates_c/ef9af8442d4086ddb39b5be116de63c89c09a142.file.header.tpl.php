<?php /* Smarty version Smarty-3.1.19, created on 2014-09-10 01:47:03
...
"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="/controller/user/userHandler.php?num=<?php echo $_SESSION['user']['num'];?>
&type=admin"><i class="icon-tasks"></i> 网站维护</a></li>
							<?php }?>
							<li class="divider"></li>
